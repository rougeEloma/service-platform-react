    ...
    <div className='SingleService'>
        <div className='container'>
            <div className="left">
                ...
                <div className="user">
                    <img src="https://images.pexels.com/photos/774909/pexels-photo-774909.jpeg?auto=compress&cs=tinysrgb&w=1600" alt="" className="pp"/>
                    <span>John Doe</span>
                    <div className="stars">
                ...
                <Slider slideToShow={1} arrowScromm={1} className="slider">
